...
SECRET_KEY = 'django-insecure-$e0w6+$f7qy+pcnkke=cs575=#9yd2fs(&c7k87-86qjw-s(w4'
...
# Simple JWT token configuration to implement access/refresh logic
SIMPLE_JWT = {
...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user_create': 'finder.serializers.UserCreateSerializer',
        'user': 'finder.serializers.UserCreateSerializer',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, '../airport-finder')
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
